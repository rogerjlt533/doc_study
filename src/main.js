...
import { faPollH, faCalendarDay, faTrashCan, faTrashAlt, faBell, faSlidersH, faPlayCircle, faStopCircle, faSyncAlt, faPlusSquare, faEllipsisH, faQuoteLeft, faUndo, faEdit, faArrowDown, faArrowUp, faTimesCircle, faProjectDiagram, faHistory, faTrashRestore, faLayerGroup, faUser, faLock, faClock, faHashtag, faBold, faUnderline, faListUl, faListOl,  faFaceLaugh, faImage, faBook, faLink, faChevronCircleLeft, faFan, faCheckCircle, faInfoCircle, faArrowsAlt, faUserFriends, faCaretRight, faAngleDown, faAngleUp, faCodeMerge, faCode, faItalic, faGripVertical, faPlus, faMinus, faThumbtack, faCog, faHdd, faEnvelopeOpenText, faStickyNote, faSync, faFileExport, faCheck, faRightLong, faCircle, faCircleXmark, faAngleRight, faChartBar, faBoxOpen, faGear, faXmark, faFileLines, faLightbulb, faAnglesLeft, faAnglesRight, faAngleLeft, faMaximize, faMinimize, faTags, faEye, faArrowDown19, faArrowDown91, faGrip, faCalendarDays, faStrikethrough, faAlignLeft, faAlignCenter, faAlignRight, faAlignJustify } from '@fortawesome/free-solid-svg-icons'
